...
// STUDENT: HOME
// ══════════════════════════════════════════════════════════════
function getNextStep() {  const COURSES = [    { id: 'starter', label: 'Starter', lessons: Array.from({ length: 8 }, (_, i) => ({ id: `starter-${i+1}`, label: `Lesson ${i+1}` })) },    { id: 'a1', label: 'A1', lessons: Array.from({ length: 10 }, (_, i) => ({ id: `a1-${i+1}`, label: `Lesson ${i+1}` })) },    { id: 'a2', label: 'A2', lessons: Array.from({ length: 10 }, (_, i) => ({ id: `a2-${i+11}`, label: `Lesson ${i+11}` })) },    { id: 'b1', label: 'B1', lessons: Array.from({ length: 10 }, (_, i) => ({ id: `b1-${i+21}`, label: `Lesson ${i+21}` })) },    { id: 'b2', label: 'B2', lessons: [1,2,3,4,6,7,8,9,11,12,13,14,16,17,18,19].map(n => ({ id: `b2-${n}`, label: `Unit ${n}` })) },  ];  const COURSES = [    { id: 'starter', label: 'Starter', lessons: Array.from({ length: 8 }, (_, i) => ({ id: `starter-${i+1}`, label: `Lesson ${i+1}` })) },    { id: 'a1', label: 'A1', lessons: Array.from({ length: 10 }, (_, i) => ({ id: `a1-${i+1}`, label: `Lesson ${i+1}` })) },    { id: 'a2', label: 'A2', lessons: Array.from({ length: 10 }, (_, i) => ({ id: `a2-${i+11}`, label: `Lesson ${i+11}` })) },    { id: 'b1', label: 'B1', lessons: Array.from({ length: 10 }, (_, i) => ({ id: `b1-${i+21}`, label: `Lesson ${i+21}` })) },  const COURSES = [    { id: 'starter', label: 'Starter', lessons: Array.from({ length: 8 }, (_, i) => ({ id: `starter-${i+1}`, label: `Lesson ${i+1}` })) },    { id: 'a1', label: 'A1', lessons: Array.from({ length: 10 }, (_, i) => ({ id: `a1-${i+1}`, label: `Lesson ${i+1}` })) },  const COURSES = [
