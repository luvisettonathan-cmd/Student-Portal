...
function renderSidebar(isAdmin) {
  ...
  if (isAdmin) {
    ...
    const adminLinks = [
      ...
      { id: 'admins', label: 'Admins', iconName: 'cog' }, { id: 'tab-home', label: 'Home', iconName: 'home' }, { id: 'tab-daily', label: 'Daily Practice', iconName: 'spark' }, { id: 'tab-aulas', label: 'Aulas', iconName: 'book' }, { id: 'tab-exercicios', label: 'Exercicios', iconName: 'stack' }, { id: 'tab-materiais', label: 'Materiais', iconName: 'compass' }, { id: 'tab-gramatica', label: 'Ref. Gramatical', iconName: 'info' }, { id: 'tab-prova', label: 'Prova', iconName: 'sparkle' }, { id: 'tab-chat', label: 'Chat com IA', iconName: 'waveform' }, { id: 'tab-comunidades', label: 'Comunidades', iconName: 'users' },
    ];
...
function renderAdminPanel() {
  ...
  switch (state.adminSubTab) {
    ...
    case 'admins': d.appendChild(renderAdminAdmins()); break; case 'tab-home': d.appendChild(renderAdminTabHome()); break; case 'tab-daily': d.appendChild(renderAdminTabDaily()); break; case 'tab-aulas': d.appendChild(renderAdminTabAulas()); break; case 'tab-exercicios': d.appendChild(renderAdminTabExercicios()); break; case 'tab-materiais': d.appendChild(renderAdminTabMateriais()); break; case 'tab-gramatica': d.appendChild(renderAdminTabGramatica()); break; case 'tab-prova': d.appendChild(renderAdminTabProva()); break; case 'tab-chat': d.appendChild(renderAdminTabChat()); break; case 'tab-comunidades': d.appendChild(renderAdminTabComunidades()); break;
  }
